-- Patch mt5_webhook_sync: support multi-timeframe candle format from EA v5.
-- New EA sends {"M5":{sym_data},"M15":{sym_data},"H1":{sym_data},"H4":{sym_data}}.
-- Old format {"timeframe":"M5","data":{...}} still works (backwards compat).
